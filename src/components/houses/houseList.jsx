...
export default function HouseList() {
	const headerTh = [
		{ name: 'Code', className: 'text-center' },
		{ name: 'Address', className: 'text-left' },
		{ name: 'Information', className: 'text-left' },
		{ name: 'Price', className: 'text-left' },
					...
					<tbody className="text-gray-400 text-sm font-light">
						{houses.map((house) => (
							<tr key={house.code} className="border-b border-gray-700 hover:bg-gray-700 hover:text-white">
								...
								<td className="py-3 px-6 text-left">{`$${Number(
									house.price,
