...
const Option = ({ href, d, name, bgColorVector, hoverColor, onClick }) => {
	return (
		<Link
			to={href}
			className={`flex items-center transform transition-colors duration-200 border-r-4 border-transparent hover:${hoverColor ? hoverColor: "border-indigo-700"}`}
            onClick={onClick}
		>
...
const DropDownMenu = ({ name, src, onClick }) => {
						...
						<div className="absolute w-60 px-5 py-3 dark:bg-gray-800 bg-white rounded-lg shadow border dark:border-transparent mt-5">
							<ul className="space-y-3 dark:text-white">
                                ...
                                <li className="font-medium">
                                        <Option 
                                            href={"#"}
                                            d={"M3 13a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-9z M7 11V7a5 5 0 0 1 10 0v4"}
