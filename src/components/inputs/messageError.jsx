export default function MessageError({message, isMessageGeneral = false}) {
	return (
		<p className={`${isMessageGeneral? "text-lg mt-3": "text-base"} text-red-500 flex items-center mb-5` }>
			<svg
